...
poptrie160_init(struct poptrie160 *poptrie, int sz1, int sz0)
{
    ...
    if ( NULL == poptrie ) {
        /* Allocate new one */
        poptrie =vmalloc(sizeof(struct poptrie160));
        if ( NULL == poptrie ) {
            return NULL;
        }
    ...
    poptrie->cnodes =vmalloc(sizeof(*poptrie->cnodes) * (1 << sz1));
    ...
    poptrie->cleaves =vmalloc(sizeof(*poptrie->cleaves) * (1 << sz0));
    ...
    poptrie->dir =vmalloc(sizeof(u32) << POPTRIE_S);
    if ( NULL == poptrie->dir ) {
        poptrie160_release(poptrie);
        return NULL;
    }
    ...
    poptrie->altdir =vmalloc(sizeof(u32) << POPTRIE_S);
    ...
    poptrie->fib.entries =vmalloc(sizeof(void *) * POPTRIE_INIT_FIB_SIZE);
